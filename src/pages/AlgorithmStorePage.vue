  ...
  <div class="page-container">
    ...
    <div class="store">
      <AlgorithmItem
        ...
        description="The CAD scoring algorithm provides a quantitative evaluation of the structural similarity between a protein's active site and a reference model."
        :timesLeft="3"
        :price="19"
      ...
      <AlgorithmItem
        ...
        description="The Temporal Dynamic Localization Design System utilizes light-sensitive components and localization tags to achieve time-controlled regulation of protein localization."
        :timesLeft="0"
        :price="19"
        @open-dialog="openDialog"
      />
      <AlgorithmItem
        ...
        description="The Optimized Protein Evolution Localization System uses computational algorithms to assist in protein evolution."
        :timesLeft="3"
        :price="19"
        @open-dialog="openDialog"
      />
      <AlgorithmItem
        ...
        description="The Protein Localization Prediction System analyzes protein sequences and structural features using advanced algorithms to predict protein localization within cells."
        :timesLeft="3"
        :price="19"
        @open-dialog="openDialog"
      />
