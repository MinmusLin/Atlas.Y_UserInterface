<template>
  <div class='page-container'>
    ...
    <div class='title-container'>
      ...
      <span class='results'>
        <span class='row-number'>{{ g_matchingResults_dynamic.length }}</span> results
      </span>
    </div>
    ...
    <div class='pagination-container'>
      <el-pagination v-model:currentPage='currentPage'
                     :page-size='pageSize'
                     :total='g_matchingResults_dynamic.length'
                     background
                     pager-count='6'
...
const currentPageData = computed(() => {
  ...
  return g_matchingResults_dynamic.value.slice(start, end)
})
...
const getColor = (row: any) => {
  const index = g_matchingResults_dynamic.value.indexOf(row)
  const totalItems = g_matchingResults_dynamic.value.length
