<template>
  <div class='page-container'>
    ...
    <el-breadcrumb :separator-icon='ArrowRight' class='breadcrumb'>
      ...
      <el-breadcrumb-item :to='`/dynamic-designer/global-cad-score/${fpId}`'>
          ...
          <p>
            ...
            <InfoTooltip height='129px'
              ...
              <ul style='margin-left: 20px'>
                ...
                <li><span style='font-weight: 600'>Select</span>: Click the left mouse button to select a residue site.
                </li>
              </ul>
            </InfoTooltip>
          </p>
